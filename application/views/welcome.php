...
<div id="main-slide" class="ts-flex-slider">
	...
	<div class="flexSlideshow flexslider">
		<ul class="slides">
			<li>
				<div class="overlay2">
					<img class="" src="<?= base_url() ;?>assets/images/slider/bg1.jpg" alt="slider">
				</div>
				<div class="flex-caption slider-content">
					<div class="col-md-12 text-center">
						...
						<p class="animated4"><a href="<?= base_url() ;?>assets/#" class="slider btn btn-primary white">Check Now</a></p>
					</div>
				</div>
			</li>
			<li>
				<div class="overlay2">
					<img class="" src="<?= base_url() ;?>assets/images/slider/bg2.jpg" alt="slider">
				</div>
				<div class="flex-caption slider-content">
					<div class="col-md-12 text-center">
						<h2 class="animated4">
						...
						<p class="animated6"><a href="<?= base_url() ;?>assets/#" class="slider btn btn-primary white">Buy Now</a></p>	     
					</div>
				</div>
			</li>
			<li>
				<div class="overlay2">
					<img class="" src="<?= base_url() ;?>assets/images/slider/bg3.jpg" alt="slider">
				</div>
				<div class="flex-caption slider-content">
					<div class="col-md-12 text-center">
						<h2 class="animated7">
						...
						<div class="">
							<a class="animated4 slider btn btn-primary btn-min-block white" href="<?= base_url() ;?>assets/#">Get Now</a><a class="animated4 slider btn btn-primary btn-min-block solid" href="<?= base_url() ;?>assets/#">Live Demo</a>
						</div>     
					</div>
				</div>
			</li>
	...
	<div class="row">
		<div class="landing-tab clearfix">
			<ul class="nav nav-tabs nav-stacked col-md-3 col-sm-5">
				  <li class="active">
					  <a class="animated fadeIn" href="<?= base_url() ;?>assets/#tab_a" data-toggle="tab">
				  ...
				  <li>
					  <a class="animated fadeIn" href="<?= base_url() ;?>assets/#tab_b" data-toggle="tab">
				 ...
				 <li>
					  <a class="animated fadeIn" href="<?= base_url() ;?>assets/#tab_c" data-toggle="tab">
				...
				<li>
					  <a class="animated fadeIn" href="<?= base_url() ;?>assets/#tab_d" data-toggle="tab">
				...
				<li>
					  <a class="animated fadeIn" href="<?= base_url() ;?>assets/#tab_e" data-toggle="tab">
...
<div class="container">
	...
	<div class="row text-center">
		<div class="isotope-nav" data-isotope-nav="isotope">
			<ul>
				<li><a href="<?= base_url() ;?>assets/#" class="active" data-filter="*">All</a></li>
				<li><a href="<?= base_url() ;?>assets/#" data-filter=".web-design">Web Design</a></li>
				<li><a href="<?= base_url() ;?>assets/#" data-filter=".development">Development</a></li>
				<li><a href="<?= base_url() ;?>assets/#" data-filter=".joomla">Joomla</a></li>
				<li><a href="<?= base_url() ;?>assets/#" data-filter=".wordpress">Wordpress</a></li>
			</ul>
		</div>
	...
	<div class="row">
		<div id="isotope" class="isotope">
			<div class="col-sm-3 web-design isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio1.jpg" alt="">
						<figcaption>
							<h3>Startup Business</h3>
							<a class="link icon-pentagon" href="<?= base_url() ;?>assets/portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="<?= base_url() ;?>assets/images/portfolio/portfolio-bg1.jpg"><i class="fa fa-search"></i></a>            
						</figcaption>			
					</figure>
				</div>
			...
			<div class="col-sm-3 development isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio2.jpg" alt="">
						<figcaption>
							<h3>Easy to Lanunch</h3>
							<a class="link icon-pentagon" href="<?= base_url() ;?>assets/portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="<?= base_url() ;?>assets/images/portfolio/portfolio-bg2.jpg"><i class="fa fa-search"></i></a>            
						</figcaption>				
					</figure>
				</div>
			</div><!-- Isotope item end -->
			...
			<div class="col-sm-3 joomla isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio3.jpg" alt="">
						<figcaption>
							<h3>Your Business</h3>
							<a class="link icon-pentagon" href="<?= base_url() ;?>assets/portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="<?= base_url() ;?>assets/images/portfolio/portfolio-bg3.jpg"><i class="fa fa-search"></i></a>            
						</figcaption>				
					</figure>
				</div>
			</div><!-- Isotope item end -->
			...
			<div class="col-sm-3 wordpress isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio4.jpg" alt="">
						<figcaption>
							<h3>Prego Match</h3>
							<a class="link icon-pentagon" href="<?= base_url() ;?>assets/portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="<?= base_url() ;?>assets/images/portfolio/portfolio-bg4.jpg"><i class="fa fa-search"></i></a>            
						</figcaption>					
					</figure>
				</div>
			</div><!-- Isotope item end -->
			...
			<div class="col-sm-3 joomla isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio5.jpg" alt="">
						<figcaption>
							<h3>Fashion Brand</h3>
							<a class="link icon-pentagon" href="<?= base_url() ;?>assets/portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="<?= base_url() ;?>assets/images/portfolio/portfolio-bg5.jpg"><i class="fa fa-search"></i></a>            
						</figcaption>					
					</figure>
				</div>
			</div><!-- Isotope item end -->
			...
			<div class="col-sm-3 development isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio6.jpg" alt="">
						<figcaption>
							<h3>The Insidage</h3>
							<a class="link icon-pentagon" href="<?= base_url() ;?>assets/portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="<?= base_url() ;?>assets/images/portfolio/portfolio-bg1.jpg"><i class="fa fa-search"></i></a>            
			...
			<div class="col-sm-3 development isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio7.jpg" alt="">
						<figcaption>
							<h3>Light Carpet</h3>
							<a class="link icon-pentagon" href="<?= base_url() ;?>assets/portfolio-item.html"><i class="fa fa-link"></i></a>
							<a class="view icon-pentagon" data-rel="prettyPhoto" href="<?= base_url() ;?>assets/images/portfolio/portfolio-bg2.jpg"><i class="fa fa-search"></i></a>            
			...
			<div class="col-sm-3 development isotope-item">
				<div class="grid">
					<figure class="effect-oscar">
						<img src="<?= base_url() ;?>assets/images/portfolio/portfolio8.jpg" alt="">
						<figcaption>
...
<div class="container">
	<div class="row">
		<div class="col-md-12 text-center">
			...
			<p>
				<a href="<?= base_url() ;?>assets/#" class="btn btn-primary white">Purchase Now</a>
				<a href="<?= base_url() ;?>assets/#" class="btn btn-primary solid">Get In Touch</a>
			</p>
		</div>
	</div>
</div><!-- Container end -->
...
<div class="container">
	...
	<div class="row text-center">
		<div class="col-md-3 col-sm-6">
			<div class="team wow slideInLeft">
				<div class="img-hexagon">
					<img src="<?= base_url() ;?>assets/images/team/team1.jpg" alt="">
				...
				<div class="team-content">
					...
					<div class="team-social">
						<a class="fb" href="<?= base_url() ;?>assets/#"><i class="fa fa-facebook"></i></a>
						<a class="twt" href="<?= base_url() ;?>assets/#"><i class="fa fa-twitter"></i></a>
						<a class="gplus" href="<?= base_url() ;?>assets/#"><i class="fa fa-google-plus"></i></a>
						<a class="linkdin" href="<?= base_url() ;?>assets/#"><i class="fa fa-linkedin"></i></a>
						<a class="dribble" href="<?= base_url() ;?>assets/#"><i class="fa fa-dribbble"></i></a>
					</div>
				</div>
			</div>	
		</div><!--/ Team 1 end -->
		<div class="col-md-3 col-sm-6">
			<div class="team wow slideInLeft">
				<div class="img-hexagon">
					<img src="<?= base_url() ;?>assets/images/team/team2.jpg" alt="">
					<span class="img-top"></span>
					<span class="img-bottom"></span>
				</div>
				<div class="team-content">
		...
		<div class="col-md-3 col-sm-6">
			<div class="team wow slideInRight">
				<div class="img-hexagon">
					<img src="<?= base_url() ;?>assets/images/team/team3.jpg" alt="">
					<span class="img-top"></span>
					<span class="img-bottom"></span>
				</div>
				<div class="team-content">
		...
		<div class="col-md-3 col-sm-6">
			<div class="team animate wow slideInRight">
				<div class="img-hexagon">
					<img src="<?= base_url() ;?>assets/images/team/team4.jpg" alt="">
					<span class="img-top"></span>
					<span class="img-bottom"></span>
				</div>
				<div class="team-content">
		...
		<div id="testimonial-carousel" class="owl-carousel owl-theme text-center testimonial-slide">
			<div class="item">
				  <div class="testimonial-thumb">
					<img src="<?= base_url() ;?>assets/images/team/testimonial1.jpg" alt="testimonial">
				  </div>
			...
			<div class="item">
				  <div class="testimonial-thumb">
					<img src="<?= base_url() ;?>assets/images/team/testimonial2.jpg" alt="testimonial">
				  </div>
				<div class="testimonial-content">
					<p class="testimonial-text">
					  Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose. Lorem Ipsum is that it as opposed to using.
			...
			<div class="item">
				<div class="testimonial-thumb">
					<img src="<?= base_url() ;?>assets/images/team/testimonial3.jpg" alt="testimonial">
				</div>
				  <div class="testimonial-content">
					<p class="testimonial-text">
					  Lorem Ipsum as their default model text, and a search for ‘lorem ipsum’ will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose. Lorem Ipsum is that it as opposed to using.
